...
public final class FragmentMainBinding implements ViewBinding {
  ...
  private FragmentMainBinding(@NonNull ConstraintLayout rootView,
      @NonNull ConstraintLayout fragmentMain, @NonNull TextView textView) {
  ...
  public static FragmentMainBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      ConstraintLayout fragmentMain = (ConstraintLayout) rootView;
      ...
      return new FragmentMainBinding((ConstraintLayout) rootView, fragmentMain, textView);
    }
